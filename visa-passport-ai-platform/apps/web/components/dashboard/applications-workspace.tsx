...
export function ApplicationsWorkspace() {
  ...
  const loadApplications = useCallback(async () => {
    try {
      ...
      setError(requestError instanceof ApiError ? requestError.message : "Unable to load applications");
    } finally {
      setIsLoading(false);
    }
  }, []);
  ...
  useEffect(() => {
    ...
    apiRequest<VisaApplicationsResponse>("/api/applications")
      ...
      .catch((requestError: unknown) => {
        if (!cancelled) setError(requestError instanceof ApiError ? requestError.message : "Unable to load applications");
      })
